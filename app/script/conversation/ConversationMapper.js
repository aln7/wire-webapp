  ...
  update_self_status(conversation_et, self) {
    if (conversation_et) {
      ...
      if (self.last_event_timestamp) {
        conversation_et.set_timestamp(self.last_event_timestamp, z.conversation.TIMESTAMP_TYPE.LAST_EVENT_TIMESTAMP);
      }

      if (self.archived_timestamp) {
        conversation_et.set_timestamp(self.archived_timestamp, z.conversation.TIMESTAMP_TYPE.ARCHIVED_TIMESTAMP);
        conversation_et.archived_state(self.archived_state);
      }

      if (self.cleared_timestamp) {
        conversation_et.set_timestamp(self.cleared_timestamp, z.conversation.TIMESTAMP_TYPE.CLEARED_TIMESTAMP);
      }

      if (self.last_read_timestamp) {
        conversation_et.set_timestamp(self.last_read_timestamp, z.conversation.TIMESTAMP_TYPE.LAST_READ_TIMESTAMP);
      }

      if (self.last_server_timestamp) {
        conversation_et.set_timestamp(self.last_server_timestamp, z.conversation.TIMESTAMP_TYPE.LAST_SERVER_TIMESTAMP);
      }

      if (self.muted_timestamp) {
        conversation_et.set_timestamp(self.muted_timestamp, z.conversation.TIMESTAMP_TYPE.MUTED_TIMESTAMP);
      ...
      if (self.otr_archived !== undefined) {
        ...
        conversation_et.set_timestamp(otr_archived_timestamp, z.conversation.TIMESTAMP_TYPE.ARCHIVED_TIMESTAMP);
      ...
      if (self.otr_muted !== undefined) {
        ...
        conversation_et.set_timestamp(otr_muted_timestamp, z.conversation.TIMESTAMP_TYPE.MUTED_TIMESTAMP);
